...
var SettingsPage = /*#__PURE__*/function (_ExtensionPage) {
  ...
  _proto.content = function content() {
    var horizonUrl = flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().forum.attribute('adminUrl') + '/horizon';
    return m("div", {
      className: "container"
    }, m("div", {
...
flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('blomstra/horizon', function () {
  flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().extensionData["for"]('blomstra-horizon').registerPage(_components_SettingsPage__WEBPACK_IMPORTED_MODULE_1__["default"]);
});
